...
public class GTLElements {
    ...
    public static Element QUANTUM_CHROMO_DYNAMICALLY_CONFINED_MATTER;
    ...
    public static void init() {
        ...
        COSMICNEUTRONIUM = GTElements.createAndRegister(0, 20000, -1, null, "cosmic_neutronium", "Cnt", false);
        ...
        AWAKENEDDRACONIUM = GTElements.createAndRegister(16000, 16000, -1, null, "awakened_draconium", "✵Dc✵", true);
        ...
        QUANTUM_CHROMO_DYNAMICALLY_CONFINED_MATTER = GTElements.createAndRegister(1000, 2000, -1, null, "quantum_chromo_dynamically_confined_matter", "§b§ke§r§b(u₂)d(c₂)s(t₂)bg§ke", true);
        TRANSCENDENTMETAL = GTElements.createAndRegister(200, 500, -1, null, "transcendent_metal", "§kmetal", false);
        ...
        ASTRALTITANIUM = GTElements.createAndRegister(1000, 1000, -1, null, "astral_titanium", "✧◇✧", false);
        CELESTIALTUNGSTEN = GTElements.createAndRegister(10000, 10000, -1, null, "celestial_tungsten", "✦◆✦", false);
        QUANTANIUM = GTElements.createAndRegister(800, 800, -1, null, "quantanium", "Qt", false);
        HEXAPHASECOPPER = GTElements.createAndRegister(152936, 52460, -1, null, "hexaphasecopper", "✢", false);
        MERCURY194 = GTElements.createAndRegister(80, 114, -1, null, "mercury194", "Hg¹⁹⁴", true);
