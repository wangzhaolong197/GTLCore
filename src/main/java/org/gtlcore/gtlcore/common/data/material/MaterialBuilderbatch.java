...
public class MaterialBuilderbatch {
    ...
    public static void init() {
        ...
        CondensedMagicSource = new Material.Builder(GTLCore.id("condensed_magic_source"))
                .gem()
                .color(0x9955AA)
                .iconSet(DIAMOND)
                .flags()
    ...
    /// .color(color)
    /// .iconSet(RUBY)
    /// .flags(GTLMaterialFlags.GENERATE_MAGICCRYSTAL, GTLMaterialFlags.DISABLE_ORE)
    /// .buildAndRegister();
    /// }
    ///
    /// public static void init() {
