...
public class VacuumPumpMachine extends SimpleTieredMachine implements IVacuumMachine {
    ...
    public void attachTooltips(TooltipsPanel tooltipsPanel) {
        ...
        tooltipsPanel.attachTooltips(new IFancyTooltip.Basic(() -> GuiTextures.INFO_ICON, () -> List.of(Component.translatable("gtlcore.recipe.vacuum.tier", getVacuumTier())), () -> true, () -> null));
    }
}
