...
public class PlatGroupMetals {
    ...
    public static void init(Consumer<FinishedRecipe> provider) {
        CHEMICAL_RECIPES.recipeBuilder(GTLCore.id("pgs_from_chalcocite")).duration(110).EUt(VA[LV])
        ...
        CHEMICAL_RECIPES.recipeBuilder(GTLCore.id("pgs_from_bornite")).duration(110).EUt(VA[LV])
        ...
        CHEMICAL_RECIPES.recipeBuilder(GTLCore.id("pgs_from_tetrahedrite")).duration(110).EUt(VA[LV])
        ...
        CHEMICAL_RECIPES.recipeBuilder(GTLCore.id("pgs_from_cooperite")).duration(150).EUt(VA[LV])
        ...
        // Aqua Regia
        // HNO3 + HCl -> [HNO3 + HCl]
        MIXER_RECIPES.recipeBuilder(GTLCore.id("aqua_regia")).duration(130).EUt(VA[LV])
                .inputFluids(NitricAcid.getFluid(1000))
                .inputFluids(HydrochloricAcid.getFluid(2000))
                .outputFluids(AquaRegia.getFluid(3000))
                .save(provider);

        CENTRIFUGE_RECIPES.recipeBuilder(GTLCore.id("pgs_separation")).duration(40).EUt(VA[HV])
        ...
        GTLRecipeTypes.DEHYDRATOR_RECIPES.recipeBuilder(GTLCore.id("crude_rhodium_metallic_powder"))
        ...
        DISTILLATION_RECIPES.recipeBuilder(GTLCore.id("acidic_osmium_solution_separation"))
        ...
        CHEMICAL_RECIPES.recipeBuilder(GTLCore.id("osmium_tetroxide_separation"))
        ...
        CHEMICAL_RECIPES.recipeBuilder(GTLCore.id("iridium_chloride_separation"))
